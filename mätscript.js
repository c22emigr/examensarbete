...
// @version      2025-05-13
// @description  Förbättrat mätscript med robust omdirigering och fail-safes
// @author       You
...
function waitForImages(timeout = 2500) {
...
function measure() {
    ...
    if (!isNaN(oldVal) && previousSearch) {
        waitForImages().then(() => {
            ...
            console.log(`VISUELL Mätning #${counter} för "${previousSearch}": ${delta} ms`);
